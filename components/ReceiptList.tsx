...
function ReceiptList() {
  ...
  if (!receipts) {
    return (
      <div className="w-full p-8 text-center">
        <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 borde-blue-500 mx-auto"></div>
  ...
  return (
    <div className="w-full">
      <h2 className="text-lg font-bold mb-4">Your receipts</h2>
