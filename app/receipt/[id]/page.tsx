...
function Receipt() {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // Creating a temporary link and trigger download
  ...
  const handleDeleteReceipt = async () => {
    ...
    if (
      window.confirm(
        "Are you sure you want to delete this receipt? This action can not be undone.",
      )
    ) {
      try {
        setIsDeleting(true);

        // call the server actions to delete the receipt
        ...
        alert("Failed to delete the receipt. Try deleting again.");
        setIsDeleting(false);
      }
    }
  };
  ...
  if (receipt === undefined) {
    return (
      <div className="container mx-auto py-20 px-4">
        <div className="flex flex-col items-center justify-center spcae-y-4">
  ...
  // Check if the receipt has the extracted data
  ...
  return (
    <div className="contain mx-auto py-10 px-4">
      <div className="max-w-4xl mx-auto">
        <nav className="mb-6">
          <Link
            href="/receipts"
            className="text-blue-500 hover:undeline flex items-center"
          >
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden mb-6">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Download */}
              <div className="flex items-center justify-cetner p-8 bg-gray-50 rounded-lg ">
                <div className="text-center">
                  <FileText className="h-16 w-16 text-blue-500 mx-auto" />
                  <p className="mt-4 text-sm text-gray-500">PDF review</p>
                  {downloadUrl && (
                    <a
                      href={downloadUrl}
                      target="_blank"
            ...
            {hasExtractedData && (
              <div className="mt-8">
                ...
                {/* Merchant details */}
                <h4 className="font-medium text-gray-700 m3-4">
                    ...
                    {isSummariesEnabled ? (
                      <div className="mt-6 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-100 shadow-sm">
                        ...
                        <div className="mt-3 text-xs text-blue-600 italic flex items-center">
                          ...
                          <span>
                            AI-generated receipt summary based on data
                          </span>
                        </div>
                      </div>
                    ) : (
                      <div className="mt-6 bg-gray-100 p-6 rounded-lg border border-gray-200 shadow-sm">
                        ...
                        <div className="bg-white opacity-50 rounded-lg p-4 border border-gray-200 flex flex-col items-center justify-center">
                          <Link
                            href="/manage-plan"
                        ...
                        <div className="mt-3 text-xs text-gray-400 italic flex items-center">
                          <Lightbulb className="h-3 w-3 mr-1" />
                          <span>
                            Get AI-powered insights from your reciepts
                          </span>
                        </div>
                      </div>
                    )}
