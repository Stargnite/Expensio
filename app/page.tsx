    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-blue-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        <div className="mt-12 flex justify-center">
          <div className="relative w-full max-w-3xl rounded-lg border border-gray-200 bg-white shadow-lg overflow-hidden dark:bg-gray-800 dark:border-gray-950">
            <div>
              <p className="p-6 md:p-8 relative">Drop items here...</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Features */}
      <section id="features" className="py-6 md:py-24">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[700xpx] text-gray-500 md:text-xl dark:text-gray-400">
                Our AI-Powered platform transform how you handle receipt and
                track expenses.
              </p>
            </div>
      ...
      {/* Pricing */}
      <section className="py-6 md:py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 max-w-5xl mx-auto">
            {/* Free Tier */}
            <div
              className="flex flex-col p-6 bg-white border  border-gray-200 rounded-lg shadow-sm dark:border-gray-800
            dark:bg-gray-950"
            >
              <div className="space-y-2">
              ...
              <ul className="mt-6 space-y-2 flex-1">
                <li className="flex items-center">
                  ...
                  <span className="">2 scans per month</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">Basic data extraction</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">7-day history</span>
                </li>
              </ul>
              <div className="mt-6">
            ...
            >
              ...
              <ul className="mt-6 space-y-2 flex-1">
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">50 scans per month</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">Enhanced data extraction</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">30-day history</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">Basic export options</span>
                </li>
              </ul>
              <div className="mt-6">
                <Link href="/manage-plan">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Pro feature set for professionals!
                </p>
              </div>
              <div className="mt-4">
              ...
              <ul className="mt-6 space-y-2 flex-1">
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">300 scans per month</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">Advanced AI data extraction</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">AI summaries</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">Expense categories and tags</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">Advanced export options</span>
                </li>
                <li className="flex items-center">
                  <Check className="h-5 w-5 text-green-500 mr-2" />
                  <span className="">Unlimited history</span>
                </li>
              </ul>
              <div className="mt-6">
                <Link href="/manage-plan">
